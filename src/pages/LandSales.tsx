...
export default function LandSales() {
  ...
  const { data: sales, isLoading } = usePropertySalesManagement("land");
  ...
  const handleCreateSale = async () => {
    ...
    try {
      ...
      toast.success("Land sale registered successfully");
  ...
  return (
    <MainLayout
      ...
      subtitle="Manage land property sales and transfers"
    >
      {/* Stats Row */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {statsLoading ? (
          ...
          <>
            <StatCard
              title="Total Land Sales"
              value={stats?.landSales || 0}
              change="All time"
              changeType="neutral"
              icon={MapPin}
              variant="primary"
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="Search by sale ID, buyer, or parcel..."
            value={searchQuery}
        ...
        <div className="flex gap-2">
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="max-w-2xl">
              <DialogHeader>
                <DialogTitle>Register Land Sale</DialogTitle>
                <DialogDescription>
                  Enter the details for the land property sale.
                </DialogDescription>
              </DialogHeader>
